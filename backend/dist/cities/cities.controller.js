...
let CitiesController = class CitiesController {
    ...
    create(dto) { return this.citiesService.create(dto); }
    findAll() { return this.citiesService.findAll(); }
    findOne(cityId) { return this.citiesService.findOne(cityId); }
    update(cityId, dto) { return this.citiesService.update(cityId, dto); }
    remove(cityId) { return this.citiesService.remove(cityId); }
};
