...
let NontechadminController = class NontechadminController {
    ...
    findOne(userId) { return this.nontechadminService.findOne(userId); }
    update(userId, dto) { return this.nontechadminService.update(userId, dto); }
    remove(userId) { return this.nontechadminService.remove(userId); }
};
