...
let SuperadminController = class SuperadminController {
    ...
    create(dto) { return this.superadminService.create(dto); }
    findAll() { return this.superadminService.findAll(); }
    findOne(userId) { return this.superadminService.findOne(userId); }
    update(userId, dto) { return this.superadminService.update(userId, dto); }
    remove(userId) { return this.superadminService.remove(userId); }
};
exports.SuperadminController = SuperadminController;
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Create a superadmin' }),
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'List all superadmins' }),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get superadmin by ID' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Update a superadmin' }),
    __param(0, (0, common_1.Param)('userId')),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Delete a superadmin' }),
    __param(0, (0, common_1.Param)('userId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
