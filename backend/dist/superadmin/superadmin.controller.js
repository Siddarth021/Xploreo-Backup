...
let SuperadminController = class SuperadminController {
    ...
    findOne(id) { return this.superadminService.findOne(id); }
    update(id, dto) { return this.superadminService.update(id, dto); }
    remove(id) { return this.superadminService.remove(id); }
};
