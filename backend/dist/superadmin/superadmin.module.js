...
exports.SuperadminModule = SuperadminModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [superadmin_service_1.SuperadminService, superadmin_repository_1.SuperadminRepository],
        exports: [superadmin_service_1.SuperadminService, superadmin_repository_1.SuperadminRepository],
    })
], SuperadminModule);
