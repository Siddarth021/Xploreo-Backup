...
let TechadminController = class TechadminController {
    ...
    findOne(id) { return this.techadminService.findOne(id); }
    update(id, dto) { return this.techadminService.update(id, dto); }
    remove(id) { return this.techadminService.remove(id); }
};
