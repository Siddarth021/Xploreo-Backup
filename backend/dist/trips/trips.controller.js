...
__decorate([
    ...
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get all trips (admin)' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], TripsController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)('traveller/:travellerId'),
    (0, swagger_1.ApiOperation)({ summary: 'Get trips for a traveller' }),
    __param(0, (0, common_1.Param)('travellerId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], TripsController.prototype, "findByTraveller", null);
__decorate([
    (0, common_1.Get)('guide/:guideId'),
    (0, swagger_1.ApiOperation)({ summary: 'Get trips for a guide' }),
    __param(0, (0, common_1.Param)('guideId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], TripsController.prototype, "findByGuide", null);
__decorate([
    (0, common_1.Get)(':id'),
