...
let TripsService = class TripsService {
    ...
    plansService;
    citiesService;
    constructor(tripsRepository, travellerService, guideService, plansService, citiesService) {
    ...
    create(dto) {
        this.travellerService.findOne(dto.travellerId);
        this.guideService.findOne(dto.guideId);
        this.plansService.findOne(dto.planId);
        this.citiesService.findOne(dto.sourceCityId);
        this.citiesService.findOne(dto.destCityId);
